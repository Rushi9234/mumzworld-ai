...
**Loom Walkthrough:** https://drive.google.com/file/d/1LsnvyJOmVF35p0assgRvegNp-RS28D2k/view?usp=sharing
...
[Pydantic Schema Validation]
        ...
        ↓
Validated structured EmailResponse output
```
...
## Example Output
Note: routing is assigned deterministically in the business rules layer, not generated by the LLM.
