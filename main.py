...
def call_llm(system_prompt: str, email_text: str) -> str | None:
    """Send email to LLM. Returns raw string or None on failure."""
    url = "https://openrouter.ai/api/v1/chat/completions"
    headers = {
        "Authorization": f"Bearer {API_KEY}",
        "Content-Type": "application/json",
        "HTTP-Referer": "https://mumzworld-support.local",
    }
    payload = {
        "model": MODEL,
        "messages": [
